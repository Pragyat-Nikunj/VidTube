...
const userRegister = asyncHandler (async (req, res) => {
    ...
    try {
      ...
      console.log("Uploaded colverImage", coverImage);
    } catch (error) {
...
const updateUserAvatar = asyncHandler(async (req, res) => {
   ...
   if (!avatar.url) {
    throw new ApiError(500, "Something went wring while uploading avatar");
   }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (!coverImage.url) {
        throw new ApiError(
            500,
            "Something went wring while uploading avatar"
        );
    }
